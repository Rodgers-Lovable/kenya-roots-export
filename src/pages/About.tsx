        ...
        <section className="py-24 bg-gradient-hero text-warm-cream">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-xl md:text-2xl text-warm-cream/90 mb-8 max-w-3xl mx-auto">
              Since 2006, Jowam Coffee Traders has been connecting Kenya's
              finest coffee with specialty roasters across the globe, building
              bridges of quality and trust.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-neutral-600 mb-6">
                  ...
                  registered and incorporated under the Company's Act in the
                  Laws of Kenya and licensed under the Coffee Directorate Crops
                  Act, 2013 and the Coffee (Forms) Rules, 2002 as a licensed
                  coffee dealer and exporter in Kenya.
                </p>
                <p className="text-lg text-neutral-600 mb-6">
                  With well over thirty years of experience in the Coffee
                  industry coupled with quality control, passion and commitment
                  to service, Jowam Coffee Trading Company founders empower
                  clients by providing coffees that ensure their product sales
                  remain high. We are determined to be the best coffee dealers
                  and merchants in the region and beyond, to promote unique
                  coffees to the whole consumer world.
                </p>
                <p className="text-lg text-neutral-600 mb-8">
                  One of our main goals is to promote majority small-scale
                  farmers by marketing their coffee and thereby creating a
                  steady source of income for them. Today, we work with over 50
                  cooperatives and estates across Kenya's premier coffee
                  regions, ensuring traceability from farm to cup while
              ...
              <div className="space-y-8">
                <Card className="bg-neutral-50">
                  <CardContent className="p-8">
                    ...
                    <p className="text-neutral-600">
                      ...
                      evaluation and ensure production of the best quality
                      coffee that will, in turn, generate more income for them.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-neutral-50">
                  <CardContent className="p-8">
                    ...
                    <p className="text-neutral-600">
                      To export large volumes of coffee from the region and
                      beyond to international markets, sustain quality and help
                      in reviving coffee farming in Kenya and the region as a
        ...
        <section className="py-24 bg-background">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
                We bridge the gap between Kenya's coffee farmers and
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-warm-cream/80 max-w-2xl mx-auto">
                Our certifications ensure compliance with international
