          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
                ...
                influencing every aspect of the final cup from acidity to body
                to flavor notes.
              </p>
            </div>
        ...
        <section className="py-24 bg-kenyan-green">
          <div className="max-w-4xl mx-auto text-center px-6 lg:px-8">
            ...
            <p className="text-xl text-warm-cream/90 mb-8">
              Each region offers unique characteristics. Let us help you find
              the perfect Kenyan coffee to complement your roasting style and
