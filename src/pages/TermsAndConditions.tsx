...
const TermsAndConditions = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms and Conditions - Jowam Coffee Traders</title>
        <meta name="description" content="Read Jowam Coffee Traders' terms and conditions to understand the rules and regulations for using our services." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://jowamcoffee.co.ke/terms-and-conditions" />
      </Helmet>
