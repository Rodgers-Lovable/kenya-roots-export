            ...
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div>
                <div className="mb-8">
                  ...
                  <p className="text-lg text-neutral-600">
                    Our experienced trade team is ready to assist with all
                    aspects of your Kenyan coffee sourcing needs.
                  </p>
                </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-neutral-600 text-sm">
                            Explore long-term partnerships, private lot
                            sourcing, and custom processing arrangements.
                          </p>
                        </div>
                      </div>
                    </CardContent>
