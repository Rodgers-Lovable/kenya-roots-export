...
const gradeOptions = [
  ...
  { id: "ab", label: "AB (Screen 16-17)", description: "Balanced cup with excellent body" },
  { id: "pb", label: "PB (Peaberry)", description: "Concentrated flavors, limited availability" }
];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "We'll prepare your samples and contact you within 3-5 business days.",
      });
      ...
      <section className="relative py-24 text-warm-cream overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-warm-cream/90 mb-8 max-w-3xl mx-auto">
            Experience the exceptional quality of Kenyan coffee with professional samples 
            prepared specifically for your roasting and cupping needs.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600">
              Professional sampling process designed for specialty coffee professionals
            </p>
          </div>
            ...
            {sampleExpectations.map((expectation, index) => (
              <Card key={index} className="text-center">
                <CardContent className="pt-8 pb-6">
                  ...
                  <h3 className="text-lg font-semibold text-coffee-brown mb-2">{expectation.title}</h3>
                  <p className="text-neutral-600 text-sm">{expectation.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-24 bg-neutral-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-neutral-600">
              Please provide detailed information to help us prepare the most relevant samples for your needs.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-12">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {gradeOptions.map((grade) => (
                        <div key={grade.id} className="flex items-start space-x-3 p-4 border rounded-lg">
                          <Checkbox
                            id={grade.id}
                            checked={formData.desiredGrades.includes(grade.id)}
                            onCheckedChange={(checked) => handleGradeChange(grade.id, checked as boolean)}
                          />
                          <div>
                            <Label htmlFor={grade.id} className="font-semibold cursor-pointer">
                              {grade.label}
                            </Label>
                            <p className="text-sm text-neutral-600">{grade.description}</p>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Select value={formData.preferredRegion} onValueChange={(value) => handleInputChange("preferredRegion", value)}>
                        <SelectTrigger>
                    ...
                    <div>
                      <Label htmlFor="targetRoastProfile">Target Roast Profile</Label>
                      <Select value={formData.targetRoastProfile} onValueChange={(value) => handleInputChange("targetRoastProfile", value)}>
                        <SelectTrigger>
                    ...
                    <div>
                      <Label htmlFor="quantityInterest">Potential Order Quantity</Label>
                      <Input
                        id="quantityInterest"
                        type="text"
                        value={formData.quantityInterest}
                        onChange={(e) => handleInputChange("quantityInterest", e.target.value)}
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <div className="space-y-6">
                  <div>
                    <Label htmlFor="currentSuppliers">Current Coffee Suppliers/Origins</Label>
                    <Textarea
                      id="currentSuppliers"
                      rows={3}
                  ...
                  <div>
                    <Label htmlFor="volumeRequirements">Monthly/Annual Volume Requirements</Label>
                    <Textarea
                      id="volumeRequirements"
                      rows={3}
                      value={formData.volumeRequirements}
                      onChange={(e) => handleInputChange("volumeRequirements", e.target.value)}
                      placeholder="Describe your typical green coffee volume needs"
                    />
                  </div>
                  
                  <div>
                    <Label htmlFor="timeline">Timeline for Potential Orders</Label>
                    <Input
                      id="timeline"
                      type="text"
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <div className="space-y-6">
                  <div>
                    <Label htmlFor="specificRequests">Specific Requests or Questions</Label>
                    <Textarea
                      id="specificRequests"
                      rows={4}
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => handleInputChange("followUpConsent", checked as boolean)}
                    />
                    <Label htmlFor="followUpConsent" className="text-sm">
                      I consent to being contacted about this sample request and related coffee sourcing opportunities. *
                    </Label>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <Label htmlFor="marketingConsent" className="text-sm">
                      I would like to receive updates about new coffee lots, harvest reports, and market insights.
                    </Label>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-neutral-200">
                  ...
                  <p className="text-sm text-neutral-600 mb-6">
                    Sample preparation and shipping typically takes 3-5 business days. 
                    We'll contact you with tracking information and follow up for feedback after you've had time to evaluate the samples.
                  </p>
                  
                  <Button 
                    type="submit" 
                    size="lg" 
                    disabled={isSubmitting || !formData.followUpConsent || formData.desiredGrades.length === 0}
                    className="w-full"
                  >
                    {isSubmitting ? (
                      <>Submitting Request...</>
