...
const sustainabilityPillars = [
  {
    ...
    title: "Fair Pricing",
    description:
      "Ensuring farmers receive premium prices for their high-quality coffee",
    details:
      "We pay above-market rates and provide price premiums for quality improvements, ensuring farmers can invest in their families and farms.",
  },
  {
    icon: Users,
    ...
    details:
      "Through our partnership programs, we help farmers form strong cooperatives and provide training on sustainable farming practices.",
  },
  {
    icon: Sprout,
    ...
    details:
      "We work with farmers to implement shade-grown coffee systems and drought-resistant varietals to combat climate change effects.",
  },
  {
    icon: Leaf,
    ...
    details:
      "Our sustainability programs focus on soil conservation, water management, and maintaining healthy ecosystems around coffee farms.",
  },
];
...
const initiatives = [
  {
    ...
    image: coffeeQuality,
    description:
      "Comprehensive training programs on post-harvest processing, quality control, and sustainable farming practices.",
  ...
  },
  {
    ...
    image: cooperative,
    description:
      "Supporting the formation and strengthening of farmer cooperatives to increase bargaining power and shared resources.",
  ...
  },
  {
    ...
    description:
      "Introducing climate-adapted varietals and sustainable farming techniques to combat changing weather patterns.",
        ...
        <section className="relative py-32 gradient-hero text-warm-cream overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-xl md:text-2xl text-warm-cream/90 mb-8 max-w-3xl mx-auto">
              Building lasting partnerships with farmers while protecting the
              environment and communities that make exceptional Kenyan coffee
              possible.
            </p>
            {/* <Button
            size="lg"
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
                We believe that great coffee comes from thriving communities and
                healthy ecosystems. Our sustainability initiatives focus on
                creating positive impact across the entire value chain.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-warm-cream/90 max-w-2xl mx-auto">
                Transparency and accountability drive our sustainability
                efforts. Here's how we're making a difference.
              </p>
            </div>
        ...
        <section className="py-24 bg-neutral-50">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
                Strategic programs designed to create lasting positive change in
                coffee communities
              </p>
            </div>
              ...
              {initiatives.map((initiative, index) => (
                ...
                >
                  ...
                  <CardContent className="p-6">
                    <h3 className="text-2xl font-playfair font-bold text-coffee-brown mb-3">
                      {initiative.title}
                    </h3>
                    <p className="text-neutral-600 mb-4">
                    ...
                    <div className="pt-4 border-t border-neutral-200">
                      <Badge
                        variant="secondary"
                        className="bg-kenyan-green text-white mb-2"
                      >
                        Impact
                      </Badge>
        ...
        <section className="py-24 bg-background">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
                Hear directly from the farmers who are at the heart of our
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <blockquote className="text-lg text-neutral-700 italic mb-4">
                      "Working with Jowam has transformed our cooperative. The
                      training programs have helped us improve our coffee
                      quality and earn better prices for our families."
                    </blockquote>
                    <div className="text-coffee-brown font-semibold">
                      Mary Wanjiku
                    </div>
                    <div className="text-neutral-500">
                      Nyeri Farmers Cooperative Chair
                    </div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <blockquote className="text-lg text-neutral-700 italic mb-4">
                      "Growing coffee in the rich volcanic soils of Meru has
                      been part of my family for generations. Working with Jowam
                      Coffee Traders has opened new opportunities for us — our
                      beans are now reaching global markets while still being
                      valued for their quality at home."
                    </blockquote>
                    <div className="text-coffee-brown font-semibold">
                      Joel Kirimi -- Mburugu Estate
                    </div>
                    <div className="text-neutral-500">Meru Coffee Farmer</div>
                  </div>
                </div>
              </Card>
            </div>
        ...
        <section className="py-24 bg-charcoal text-warm-cream">
          <div className="max-w-4xl mx-auto text-center px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div>
                <div className="text-3xl font-playfair font-bold text-accent-gold mb-2">
                  50%
                </div>
            ...
            <p className="text-xl text-warm-cream/90 mb-8">
              Together, we're building a more sustainable future for Kenyan
              coffee, one farmer, one cooperative, and one cup at a time.
            </p>
