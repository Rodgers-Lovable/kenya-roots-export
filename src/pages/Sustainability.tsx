          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <blockquote className="text-lg text-neutral-700 italic mb-4">
                    ...
                    training programs have helped us improve our coffee quality
                    and earn better prices for our families."
                  </blockquote>
            ...
            <Card className="p-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <blockquote className="text-lg text-neutral-700 italic mb-4">
                    "The climate-resilient farming techniques have helped us
                    maintain good harvests even during challenging weather
                    seasons. Our farm is now more sustainable."
                  </blockquote>
                  <div className="text-coffee-brown font-semibold">
                    Joseph Kiprotich
                  </div>
